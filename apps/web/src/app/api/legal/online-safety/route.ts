import { handleLegalIntake, legalRequestTypeForOnlineSafety } from "@/lib/compliance-server";
...
export async function POST(request: Request) {
  ...
  const requestType = isRecord(body)
    ? legalRequestTypeForOnlineSafety(body)
    : "osa_illegal_content";
